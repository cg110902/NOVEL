...
| **催更员 (Critic)** | 原生子代理 (`inherit`) | Stage 4 (并行轨 B) | **老白催更便签（专供下章参考）**：扮演十年老白追更读者盲审 final 正文，输出 200~450 字便签 `log/critic/ch_XXX.md`（包含：阅读疲劳度、伏笔信息差透光度、主角活人感监控、角色路人缘体检、最想看与最怕踩），**仅供下一章细纲构思参考，无一票否决权，当章流水线直通**。落盘即交卷。 |
...
1. **Stage 1 细纲就绪（至高叙事法则与主控最终裁决权）**：
   - 🌟 **至高叙事法则**：**大纲服务于好故事，故事绝不能被死板的大纲绑架！** 若实际剧情自然流淌导致卷纲滞后，主控拥有**【动态修纲特权 (Outline Refactor)】**，可直接微调 `outlines/vol_XX/outline.md` 后面 2~3 章简述，使大纲实时对齐现实；
   - 👑 **主控最终裁决权**：算法制导胶囊、催更便签与历史余震均为参谋情报（Advisory Only），主控作为全书创作总指挥与最强大脑，在确定细纲时拥有 100% 最终拍板与裁决权；
   - ✍️ **细纲生成与落盘**：运行 `python studio.py beats new ch_XXX --write` 生成细纲脚手架后，主控**深度吸纳催更便签 4 大维度（疲劳度、伏笔信息差、主角活人感、角色路人缘）**与读者期待，将独家反套路巧思与冲突高潮注入细纲，确认细纲落盘至 `outlines/vol_XX/beats/ch_XXX.md`。
