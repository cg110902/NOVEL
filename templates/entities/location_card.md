...
<!-- 💡【Stage 0 架构师指南（填写后可删）】
     ...
     ★ 状态对齐：本 YAML 中的 id, name, type, danger_tier, danger_level, environment_rules, sensory_anchor, faction, status 均已与 实体四表（persons/items/factions/places） 法定 Schema 100% 闭环对齐！
     ★ 全题材适配：
