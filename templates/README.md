...
不仅是一次性脚手架，更是全书在 Stage 0 筑基后沉淀为 10,000~30,000 字字全景物理定律的**底层词典与机械矫正器**。后续全流水线的增删改查对账均以此为基准锚点。
...
1. **Stage 0 深度筑基规范**：
   ...
   - 由 `Architect`（架构师）在独立纯净沙盒中完成全部 `{{slot:...}}` 的深度填充，字数规模应达到 **10,000~30,000 字**；
